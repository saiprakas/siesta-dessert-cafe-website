/* ============================================================
   SIESTA WEBSITE — static site configuration.
   This website has NO backend. To change any detail below,
   edit this file and rebuild (npm run build).
   ============================================================ */
...
export const SITE = {
  ...
  hours: [{ label: "Every Day", time: "10:00 AM – 11:00 PM" }],
  about:
    "Siesta Dessert Cafe is Vijayawada's cosy corner for handcrafted desserts, New York style pizza, Belgian waffles, artisan cakes and comfort food — every single thing made purely by hand, with love and care, and never anything artificial. Born on 27th April 2026, Siesta was built on a simple idea: every sweet moment deserves a warm memory. Step in, slow down, and treat yourself — you're just a siesta away.",
  announcement: ""
};
